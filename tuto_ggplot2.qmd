...
require("knitr")
library(ggplot2)
knitr::opts_knit$set(root.dir = "~/Documents/O·D·I·L/formation_R")
```
...
Your goal is to produce the following plot showing the density distributions of the MAPK signature in function of the known oncogenes.
