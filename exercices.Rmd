...
A function is a set of instructions that you can re-use. A function is composed with a name and arguments. There is built-in functions that already exists and that you can use.
...
```{r exercice log 1}
# Search for help about the function log
?log
help(log)
```

The first thing to do is to search for help about the function. In this case, this is pretty simple because to calculate the log we use the function called "log". But we need to know what are the needed arguments.
